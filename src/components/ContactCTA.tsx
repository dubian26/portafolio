    ...
    <section id="contact" className="py-24 px-6 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-background-dark/80 text-lg md:text-xl font-medium mb-12 max-w-2xl mx-auto leading-relaxed">
          Estoy disponible para consultorías o roles de liderazgo técnico. Hablemos sobre cómo puedo aportar valor a tu equipo.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            href="mailto:contact@dubiansepulveda.com"
