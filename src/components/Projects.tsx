                     ...
                     >
                        ...
                        <div className="p-8 flex flex-col flex-1">
                           ...
                           <div className="flex items-center justify-between pt-6 border-t border-slate-700">
                              {
                                 (project.links.caseStudy || project.links.demo || project.links.docs) &&
                                 <a
                              ...
                              }
                              {
                                 ...
                                 <a
                                    ...
                                    className="text-primary font-bold text-sm flex items-center gap-1 group/link">
                                    Code <Code className="size-4 transition-transform group-hover/link:translate-x-1 group-hover/link:-translate-y-1" />
                                 </a>
                              }
                           </div>
                        </div>
